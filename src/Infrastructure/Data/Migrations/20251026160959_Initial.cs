        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHistory_ProductVariant_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Variant", x => new { x.ProductVariantId, x.OptionValueId });
                    table.ForeignKey(
                        name: "FK_Variant_OptionValue_OptionValueId",
                        column: x => x.OptionValueId,
                        principalTable: "OptionValue",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHistory_ProductVariantId",
                table: "OrderHistory",
                column: "ProductVariantId");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "ProductId",
                unique: true,
                filter: "[AllowImages] = 1");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOption_ProductId_OptionId",
                table: "ProductOption",
